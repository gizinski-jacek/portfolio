	...
	return (
		<div id='about' className={styles.about}>
			...
			<p>
				...
				freecodecamp I was able to obtain fundamental skills and knowledge of
				web developement. I am constantly seeking opportunities to learn new
				concepts, technologies, and tools to become better full-stack developer.
			</p>
			<p>
				<svg
					xmlns='http://www.w3.org/2000/svg'
				...
				kind, tuned into Formula 1 or Indycar races on the weekends, or just
